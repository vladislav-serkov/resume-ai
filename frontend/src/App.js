...
import { Upload, FileText, History, BarChart3, Bot, Download, Sparkles, Briefcase, User, Search, Eye, MessageSquare, Zap, Menu } from "lucide-react";
...
const Dashboard = () => {
  ...
  const [sidebarView, setSidebarView] = useState("quick-actions");
